...
//  Copyright Dejal Systems, LLC 2009. All rights reserved.
//
    ...
    if (indexPath.section == SimpleSection)
    {
        switch (indexPath.row)
        {
            case SimpleSectionLoadingRow:
                ...
                cell.detailTextLabel.text = @"+newActivityViewForView:";
                break;
            case SimpleSectionCustomLabelRow:
                cell.textLabel.text = @"Custom label text";
                cell.detailTextLabel.text = @"+newActivityViewForView:withLabel:";
                break;
            case SimpleSectionChangingLabelRow:
                cell.textLabel.text = @"Changing the label text";
                cell.detailTextLabel.text = @"+newActivityViewForView:withLabel:width:";
                break;
    ...
    else if (indexPath.section == KeyboardSection)
    {
        switch (indexPath.row)
        {
            case KeyboardSectionLoadingRow:
                cell.textLabel.text = @"Default \"Loading...\" label text";
                cell.detailTextLabel.text = @"+newActivityView";
                break;
            case KeyboardSectionCustomLabelRow:
                cell.textLabel.text = @"Custom label text";
                cell.detailTextLabel.text = @"+newActivityViewWithLabel:";
                break;
            default:
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section;
{
    switch (section)
    {
        ...
        case BezelSection:
            return @"DSBezelActivityView";
        case KeyboardSection:
            return @"DSKeyboardActivityView";
        default:
            return @"";
    }
}
